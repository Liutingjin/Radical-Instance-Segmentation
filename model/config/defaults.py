...
_C.MODEL.FCOS.NUM_KERNEL_CONVS = 4
_C.MODEL.FCOS.NUM_SHARE_CONVS = 0
_C.MODEL.FCOS.USE_SHARE_TRANSFORMERS = False
_C.MODEL.FCOS.NUM_SHARE_TRANSFORMERS = 4                  #12
_C.MODEL.FCOS.NUM_GRIDS = [40, 24, 16, 12, 10]            #[40, 36, 24, 16, 12]            [40, 36, 16, 10, 8]
...
_C.MODEL.SOLOV2.NUM_CLASSES = 336
