...
class EdgeGuidedModule(nn.Module):
    def __init__(self,):
        ...
        # self.iaff = iAFF(channels=channels, r=2)
        # self.dwt = MultiWaveletAttentionLayer(channels, reduction=2, level=2)
    ...
    def forward(self, mask_features, original_images):
        ...
        se_feat = self.fcanet(all_features)

        mask_pred = self.fusion(se_feat)
